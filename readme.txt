...
Tags: woocommerce, checkout, payment gateway, svea checkout, invoice
...
━━━━━━━━━
= 🎉 EXCITING NEWS: VERSION 3.0 NOW AVAILABLE! 🎉 =

We're thrilled to announce that version 3.0 of Svea Checkout for WooCommerce has been released! This major update brings:
1. Enhanced compatibility with WooCommerce plugins
2. Improved checkout page template and styling
3. Streamlined functionality mirroring WooCommerce's standard checkout

= Important Notes =
- If you use custom templates: We've made significant changes to the checkout page structure. Please review and update your custom templates as needed.
- For more complex stores: We strongly recommend testing the new version in a staging environment before updating your live site.

= What's New in 3.0 =
- Seamless integration with a wider range of WooCommerce extensions
- Refreshed and user-friendly checkout experience
- Easier customization options for developers

We've redesigned the plugin to closely follow WooCommerce's standard checkout structure, opening up new possibilities for your store!

Update now through your WordPress admin panel to take advantage of these exciting changes!

Questions? Our support team is here to help you make the most of this major update!
━━━━━━━━━
...
* Integrate nShift directly in the checkout (requires nShift account)
* Svea Instore - create orders and send payment link (seperately enabled on individual accounts)

= nShift integration (requires nShift account) =

Seamlessly integrate with nShift (formerly Unifaun) to enhance the shipping experience. By integrating with your nShift account the shipping options will be automatically supplied directly in the checkout.
Simplify the shipping options and provide a better checkout experience for your customers.
Interested in this feature? Contact Svea to get started!

= Svea Instore =

Svea Instore is an opt-in feature that enables the shop owners to create orders and send payment links via SMS to customers. This feature is designed to streamline the ordering experience for customers who prefer placing orders in person or over the phone. Enhance your customer service by offering a convenient and efficient solution for remote shopping.
Interested in this feature? Contact Svea to get started!

= Part payment module =

The plugin provides a module that can be displayed on the product pages to inform your customers that they can pay with part payments in the checkout. It will display the lowest monthly price which they can pay through part payments.

To activate the feature, follow these steps:

1. Go to **WooCommerce > Settings > Payments > Svea Checkout**
2. Check the box **Display product part payment module**
3. Select where on the page you want to display the module
4. View the part payment module on the product page for eligable products. If the module is not displayed it might be due to the price since part payment plans often require a minimum amount.

There's also a shortcode available to display the part payment module on a product page. Add the shortcode `[svea_checkout_part_payment_module]` to the product page you want to use it on. Or call `do_shortcode()` through a template file.
...
= 3.0.7 =
3.0.7 is a patch release

= 3.0.6 =
3.0.6 is a patch release

= 3.0.5 =
3.0.5 is a patch release

= 3.0.4 =
3.0.4 is a patch release

= 3.0.3 =
3.0.3 is a patch release

= 3.0.2 =
3.0.2 is a patch release

= 3.0.1 =
3.0.1 is a patch release

= 3.0.0 =
3.0.0 is a major release

= 2.8.11 =
2.8.11 is a patch release

= 2.8.10 =
2.8.10 is a patch release

= 2.8.9 =
2.8.9 is a patch release

= 2.8.8 =
2.8.8 is a patch release

= 2.8.7 =
2.8.7 is a patch release

= 2.8.6 =
2.8.6 is a patch release

= 2.8.5 =
2.8.5 is a patch release

= 2.8.4 =
2.8.4 is a patch release

= 2.8.3 =
2.8.3 is a patch release

= 2.8.2 =
2.8.2 is a patch release

= 2.8.1 =
2.8.1 is a patch release

= 2.8.0 =
2.8.0 is a minor release
...
2. Checkout page after contact details are entered and possible payment options are displayed.
3. nShift-integration with integrated shipping methods in Svea Checkout.
4. Thank-you page displayed after successful purchase through Svea Checkout.

== Changelog ==

= 3.0.7 2024-10-31 =
- Mark name fields as optional for company clients are now set to be done later to prevent other plugins from overriding
- Add more checks for WooCommerce settings to make sure phone, address field 2 and company name settings are correctly setup

= 3.0.6 2024-10-30 =
- Corrected syntax for Instore order pushes which prevented it from syncing properly
- Forcibly remove WooCommerce fields to get better support for 3rd party plugin overriding fields

= 3.0.5 2024-10-25 =
- Handle `woocommerce_enable_order_notes_field` differently to prevent it from affecting other extra fields

= 3.0.4 2024-10-24 =
- Refresh orders not using client side validation

= 3.0.3 2024-10-23 =
- Remove privacy policy text and page content since they are already present in the iframe

= 3.0.2 2024-10-22 =
- Fix rounding when using decimals in products and certain VAT-rates

= 3.0.1 2024-10-21 =
- Fix validation for company customers causing issues with WooCommerce standard fields

= 3.0.0 2024-10-21 =
- Client side validation. The creation of the order now goes via ajax on the client side
- Removed a lot of unnecessary compatibility code
- Crediting card and swish payments sometimes gave an error when using different tax rates which now has been fixed
- Better general compatibility with plugins that adds fields to the checkout
- Double check orders that could have changed payment method to ensure correct status is fetched from PaymentAdmin
- General improvements

= 2.8.11 2024-09-19 =
- Prevent issues with postal code not being sent when switching customer type.

= 2.8.10 2024-09-10 =
- Ensure all emails are being sent properly when order status changes from "Awaiting status" to "Processing/Completed".

= 2.8.9 2024-08-22 =
- Ensure country changes updates the checkout iframe

= 2.8.8 2024-08-13 =
- Correct logic of only syncing invoice fee

= 2.8.7 2024-08-09 =
- Ensure manual sync button functions correctly

= 2.8.6 2024-07-16 =
- Ensure shipping gets synced if billing and shipping zip-code doesn't match up
- Always recalculate cart items when syncing with Svea Checkout

= 2.8.5 2024-07-10 =
- Better support of known customers where postcode is masked
- Better logic of when shipping is updated

= 2.8.4 2024-07-09 =
- Ensure the checkout is updated if shipping changes during ajax

= 2.8.3 2024-07-08 =
- Added more logging
- Ensure WPML loads the correct currency and location if geolocation based currecy is enabled
- Enable WooCommerce to read the postcode correctly even if masked in Checkout

= 2.8.2 2024-06-11 =
- Corrected log message causing issue in validationCallback

= 2.8.1 2024-06-11 =
- Added compatibility with EU VAT Number
- Prevent fatal error if no connection to Svea can be made for part pay campaigns
- Ensure cancelled or failed Svea orders create a new checkout when visiting the checkout
- Allow emails to be sent when going from "Awaiting status" to "Processing"
- Added more logging
- Corrected changelog

= 2.8.0 2024-05-17 =
- Instore: create a new order as an store manager and send a payment link to the customer via email/sms.
- Prevent nShift to be deselected when switching shipping methods
- Fixed error in admin when selecting an order and later making a search
- Prevent error when creating account in checkout process and using WPML
- Remove compatibility code when using other payment methods in Ultimate affiliate pro
